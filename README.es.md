...
### 🚀 Otros Proyectos Destacados (Automatización)

| Proyecto | Stack Tecnológico | Descripción |
| :--- | :--- | :--- |
| **[AutoSorter Pro](https://github.com/Allesterdev/autosorter_pro)** | 🐍 Python, 🐳 Docker | Herramienta avanzada de automatización para organización de archivos con configuración de entorno seguro. |
...
* **DevSecOps & CI/CD:**
  ...
  * 🔒 **Herramientas SAST:** Bandit (Escaneo de Seguridad en Python)
  * 📏 **Calidad de Código:** Ruff, MyPy
  * 📱 **Google Play Console (Gestión de Releases)**

* **Lenguajes y Scripting:**
  * 🐍 **Python** (Automatización y Herramientas de Seguridad)
  * 📱 **Kotlin & Chaquopy** (Arquitectura Híbrida Android/Python)
  * 🗄️ **SQL** (SQLite y Seguridad de Datos)
  * 🐚 **Bash Scripting**
...
* **Infraestructura & Hardware:**
  ...
  * 🔧 Resolución de Problemas de Hardware y Ensamblaje de PCs.
  * 🛡️ Hardening de Redes y Protección de Infraestructuras.
...
### 📚 Otros Recursos
* Trabajo de curso teórico adicional y ejercicios menores están archivados en el directorio **[Coursework-Theory](./Coursework-Theory)**.

---

### 📡 Contacto
* **LinkedIn:** www.linkedin.com/in/oscar-campoy-ballester-sec
