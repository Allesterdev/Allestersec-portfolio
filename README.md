...
> *Native Android (Kotlin) + Python Logic + Military-Grade CI/CD Pipeline*
...
### 🚀 Other Flagship Projects (Automation)

| Project | Tech Stack | Description |
| :--- | :--- | :--- |
| **[AutoSorter Pro](https://github.com/Allesterdev/autosorter_pro)** | 🐍 Python, 🐳 Docker | Advanced automation tool for file organization featuring secure environment configuration. |
...
* **Languages & Scripting:**
  ...
  * 📱 **Kotlin & Chaquopy** (Hybrid Android/Python Architecture)
  * 🗄️ **SQL** (SQLite & Data Security)
  * 🐚 **Bash Scripting**
...
* **Infrastructure & Hardware:**
  * ☁️ VirtualBox & VM Management.
  * 🔧 Hardware Troubleshooting & PC Assembly.
  * 🛡️ Network Hardening & Infrastructure Protection.

* **Cybersecurity Frameworks:**
  * NIST Cybersecurity Framework.
  * SIEM Tools (Log Analysis).
  * IDS/IPS Configuration.
  * Food Defense Protocols (Industrial Security Background).

---

### 📚 Other Resources
* Additional theoretical coursework and minor exercises are archived in the **[Coursework-Theory](./Coursework-Theory)** directory.
